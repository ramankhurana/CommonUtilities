...
process.source = cms.Source("PoolSource",
                            ...
                            fileNames = cms.untracked.vstring('root://eoscms.cern.ch//store/user/khurana/HGCAL/GenSim/SingleParticle/gen-sim_Pt-200_Eta-2.0_ID-11.root')
                            #fileNames = cms.untracked.vstring('file:FourMuonEventsPt200GeV_inHGC.root')
                            )
...
process.mix.digitizers.hgceeDigitizer.digiCfg.shaperTau  = cms.double(TAUVALUE)
