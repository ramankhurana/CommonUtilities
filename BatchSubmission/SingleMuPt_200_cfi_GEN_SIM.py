...
# with command line options: FourMuPt_1_200_cfi --conditions auto:upgradePLS3 -n 10 --eventcontent FEVTDEBUG --relval 10000,100 -s GEN,SIM --datatier GEN-SIM --beamspot Gauss --customise SLHCUpgradeSimulations/Configuration/combinedCustoms.cust_2023HGCalMuon --geometry Extended2023HGCalMuon,Extended2023HGCalMuonReco --magField 38T_PostLS1 --fileout file:step1.root
...
process.generator = cms.EDProducer("FlatRandomPtGunProducer",
		...
		MinPt = cms.double(MAXPT),
		PartID = cms.vint32(-PDGID),
		MaxEta = cms.double(ETA),
		MaxPhi = cms.double(3.14159265359),
		MinEta = cms.double(ETA),
